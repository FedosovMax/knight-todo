...
import static com.knighttodo.character.Constants.API_BASE_SKILLS;
...
import com.knighttodo.character.factories.SkillFactory;
...
class SkillResourceIntegrationTest {
    ...
    void getSkillById_shouldReturnSkillResponseDto_whenIdIsCorrect() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(TestConstants.buildGetSkillByIdUrl(skill.getId())))
            .andExpect(status().isFound())
