...
import static com.knighttodo.character.Constants.BASE_CHARACTER;
...
import com.knighttodo.character.factories.CharacterFactory;
import com.knighttodo.character.gateway.privatedb.repository.CharacterRepository;
...
public class CharacterResourceIntegrationTest {
    ...
    public void getCharacterById_shouldReturnExistingCharacter_whenIdIsCorrect() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(TestConstants.buildGetCharacterByIdUrl(character.getId())))
            .andExpect(status().isFound())
